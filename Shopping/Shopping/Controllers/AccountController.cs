    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "El usuario no ha sido habilitado, debes de confirmar el correo enviado para poder entrar en el sistema.");
                }
        ...
        public async Task<IActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "Debes ingresar una nueva contraseña.");
                return View(model);
            }
            if (ModelState.IsValid)
            {
